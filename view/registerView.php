<!-- Register Page:
Allow users to sign up for an account by providing their username, full name, country, gender, date of birth, 
occupation, interests, email address and creating a password.-->
<!DOCTYPE html>
<html lang="en">
