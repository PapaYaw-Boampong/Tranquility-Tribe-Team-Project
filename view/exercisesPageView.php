...
<body>
    ...
    <main>
        <a href="https://www.youtube.com/watch?v=_A0udZPwHxs">
            <button class="exercise" style="background-image: url('deep_breathing.jpg');">
        ...
        <a href="https://www.youtube.com/watch?v=sTANio_2E0Q">
            <button class="exercise" style="background-image: url('yoga1.avif');">
        ...
        <a href="https://www.youtube.com/watch?v=LiUnFJ8P4gM">
            <button class="exercise" style="background-image: url('breathing.jpg');">
        ...
        <a href="https://www.youtube.com/watch?v=REL4y5a_xF8">
            <button class="exercise" style="background-image: url('flexibility.png');">
        ...
        <a href="https://www.youtube.com/watch?v=KfYkzXTut1Y">
            <button class="exercise" style="background-image: url('rain.jpg');">
        ...
        <a href="https://www.youtube.com/watch?v=ak_glVKt6-0">
            <button class="exercise" style="background-image: url('relaxing_music.webp');">
        ...
        <a href="https://www.youtube.com/watch?v=UgHKb_7884o">
            <button class="exercise" style="background-image: url('fireplace.jpg');">
        ...
        <a href="https://www.youtube.com/watch?v=nMfPqeZjc2c">
            <button class="exercise" style="background-image: url('whiteNoise.jpg');">
                <h2>White Noise</h2>
        ...
        <a href="https://www.youtube.com/watch?v=UJZxtO9XNno">
            <button class="exercise" style="background-image: url('stream.jpg');">
                <h2>Stream Sounds</h2>
        ...
        <a href="https://www.youtube.com/watch?v=Ki6xgXmxK7Y">
            <button class="exercise" style="background-image: url('flatTummy.webp');">
        ...
        <a href="https://www.youtube.com/watch?v=CGmr02bfHUo">
            <button class="exercise" style="background-image: url('bodyExercise.webp');">
        ...
        <a href="https://www.youtube.com/watch?v=lKx0sOz31C4">
            <button class="exercise" style="background-image: url('pregnant.webp');">
        ...
        <!-- <button class="plan" style="background-image: url();">
            <p class="planDescription">Create an exercise plan</p>
